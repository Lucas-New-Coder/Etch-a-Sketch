let container = document.querySelector('#container') // Seleciona o Container 
let color = document.querySelector('#color') // Seleciona o menu de cores 
let newGrid = document.querySelector('#newGrid') // Seleciona o botão newGrid
